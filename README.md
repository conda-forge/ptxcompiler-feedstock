...
Once the `conda-forge` channel has been enabled, `ptxcompiler` can be installed with:

```
conda install ptxcompiler
```

It is possible to list all of the versions of `ptxcompiler` available on your platform with:
